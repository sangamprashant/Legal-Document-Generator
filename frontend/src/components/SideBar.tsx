...
const Dashboard = ({ children }: SideBarProps) => {
    ...
    const linksList = user?.role === "advocate" ? advocateLinks : userLinks;
            ...
            >
                <div className="flex items-center justify-between p-4">
                    <Link to="/" className="flex items-center gap-2">
                        <Logo />
                        <span className="text-xl font-semibold hidden md:block text-white">Document Generator</span>
                    </Link>
